...
-these are the two categories of spatial data
-rasters are pixels. Raster data divides the landscape into a grid and then we define a value to the square. this allows us to do stuff like remote sensing.
-were not dealing with raster data
...
-features are anything you can map
...
-these are non-spatial information that are attached to our locations (ex: an ID for intersections, station name of EPA monitoring stations, etc)
...
#these are data frames will new column types (geometry) that allow us to do spatial analysis
