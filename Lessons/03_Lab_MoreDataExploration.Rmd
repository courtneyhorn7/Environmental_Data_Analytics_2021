...
```{r}
forec1 <- c(48,47,44,39,37,37,36,49,45,46)
forec2 <- c(40,34,29,28,19,24,29,30,27,27)
```
...
date_obj_today <- ymd(str_today)
#ymd is a lubridate package function
#are also ydm functions


date_obj_today
class(date_obj_today)
datetoday <- as.Date(str_today, format="%y-%b-%d")
#this is how I converted it from a class to a date
class(datetoday)
