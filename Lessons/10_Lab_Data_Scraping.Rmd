...
scode = "00003"  #mean
#changing the statistic to download daily data?
...
```{r}
#Apply the API key
census_api_key("404e7f7ab7b030e4bea8ecd0f5071461f3cdd5cb", install = TRUE, overwrite = TRUE)
#this key wont work. download your own
nc_pop <- 
  get_acs(geography = "county",
          variables = "B01003_001",
          state = "NC",
          geometry = TRUE)
#the function above gives you data and geometry for the american community survey
...
#get the tags and put them in
the_states <- the_website %>% 
  html_nodes("th:nth-child(1)") %>% 
  html_text()
...
#put return there because every time we run it we want a data frame
...
```
can use paste0 instead of paste so that you get no spaces
